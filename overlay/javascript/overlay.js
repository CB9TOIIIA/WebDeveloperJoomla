...
$(function()
{
  ...
  $("#joomla-toolbar > a").append(WebDeveloper.Locales.getString("Joomla"));
...
$(function()
{
  ...
  $("#joomla-tp1").append(WebDeveloper.Locales.getString("joomlatp1")).on("click", WebDeveloper.Overlay.Tools.joomlatp1);
  $("#joomla-tp").append(WebDeveloper.Locales.getString("joomlatp")).on("click", WebDeveloper.Overlay.Tools.joomlatp);
  $("#joomla-robots").append(WebDeveloper.Locales.getString("joomlarobots")).on("click", WebDeveloper.Overlay.Tools.joomlarobots);
  $("#joomla-admin").append(WebDeveloper.Locales.getString("admin")).on("click", WebDeveloper.Overlay.Tools.admin);
  $("#joomla-sitemap").append(WebDeveloper.Locales.getString("sitemap")).on("click", WebDeveloper.Overlay.Tools.sitemap);
  $("#joomla-sitemapxml").append(WebDeveloper.Locales.getString("sitemapxml")).on("click", WebDeveloper.Overlay.Tools.sitemapxml);
  $("#joomla-sitemapwriter").append(WebDeveloper.Locales.getString("sitemapwriter")).on("click", WebDeveloper.Overlay.Tools.sitemapwriter);
  $("#joomla-ardd").append(WebDeveloper.Locales.getString("joomlaardd")).on("click", WebDeveloper.Overlay.Tools.joomlaardd);
  $("#joomla-sectadd").append(WebDeveloper.Locales.getString("sectadd")).on("click", WebDeveloper.Overlay.Tools.sectadd);
  $("#joomla-catadd").append(WebDeveloper.Locales.getString("catadd")).on("click", WebDeveloper.Overlay.Tools.catadd);
  $("#joomla-allcontent").append(WebDeveloper.Locales.getString("allcontent")).on("click", WebDeveloper.Overlay.Tools.allcontent);
  $("#joomla-mod").append(WebDeveloper.Locales.getString("mod")).on("click", WebDeveloper.Overlay.Tools.mod);
  $("#joomla-plg").append(WebDeveloper.Locales.getString("plg")).on("click", WebDeveloper.Overlay.Tools.plg);
  $("#joomla-template").append(WebDeveloper.Locales.getString("template")).on("click", WebDeveloper.Overlay.Tools.template);
  $("#joomla-add-del").append(WebDeveloper.Locales.getString("adddel")).on("click", WebDeveloper.Overlay.Tools.adddel);
  $("#joomla-google").append(WebDeveloper.Locales.getString("joomlagoogle")).on("click", WebDeveloper.Overlay.Tools.joomlagoogle);
  $("#joomla-pingdom").append(WebDeveloper.Locales.getString("joomlapingdom")).on("click", WebDeveloper.Overlay.Tools.joomlapingdom);
  $("#joomla-quirktools").append(WebDeveloper.Locales.getString("joomlaquirktools")).on("click", WebDeveloper.Overlay.Tools.joomlaquirktools);
  $("#joomla-responsivedesign").append(WebDeveloper.Locales.getString("joomlaresponsivedesign")).on("click", WebDeveloper.Overlay.Tools.joomlaresponsivedesign);
  $("#joomla-transmog").append(WebDeveloper.Locales.getString("joomlatransmog")).on("click", WebDeveloper.Overlay.Tools.joomlatransmog);
  $("#joomla-mobiletest").append(WebDeveloper.Locales.getString("joomlamobiletest")).on("click", WebDeveloper.Overlay.Tools.joomlamobiletest);
  $("#joomla-ahrefs").append(WebDeveloper.Locales.getString("joomlaahrefs")).on("click", WebDeveloper.Overlay.Tools.joomlaahrefs);
  $("#joomla-spywords").append(WebDeveloper.Locales.getString("joomlaspywords")).on("click", WebDeveloper.Overlay.Tools.joomlaspywords);
  $("#joomla-semrush").append(WebDeveloper.Locales.getString("joomlasemrush")).on("click", WebDeveloper.Overlay.Tools.joomlasemrush);
  $("#joomla-similarweb").append(WebDeveloper.Locales.getString("joomlasimilarweb")).on("click", WebDeveloper.Overlay.Tools.joomlasimilarweb);
  $("#joomla-base64de").append(WebDeveloper.Locales.getString("joomlabase64de")).on("click", WebDeveloper.Overlay.Tools.joomlabase64de);
  $("#joomla-base64en").append(WebDeveloper.Locales.getString("joomlabase64en")).on("click", WebDeveloper.Overlay.Tools.joomlabase64en);
  $("#joomla-md5").append(WebDeveloper.Locales.getString("joomlamd5")).on("click", WebDeveloper.Overlay.Tools.joomlamd5);
  $("#joomla-regexpal").append(WebDeveloper.Locales.getString("joomlaregexpal")).on("click", WebDeveloper.Overlay.Tools.joomlaregexpal);
...
WebDeveloper.Overlay.Tools.joomlatp1 = function()
{
        ...
        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab(tab.url + "?tp=1", featureItem);
        });
};
...
WebDeveloper.Overlay.Tools.joomlatp = function()
{
 ...
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
     WebDeveloper.Overlay.openTab(getCurrentHostWithProtocol(tab.url) + "/?tp=1", featureItem);
 });
};

WebDeveloper.Overlay.Tools.admin = function()
{
 var featureItem = $(this);
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
...
WebDeveloper.Overlay.Tools.sitemap = function()
{
 var featureItem = $(this);
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
...
WebDeveloper.Overlay.Tools.joomsitechecker = function()
{
        ...
        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab("http://help.cb9t.ru/jversion.php?site=" + getCurrentHostWithProtocol(tab.url), featureItem);
        });
};



WebDeveloper.Overlay.Tools.sitemapxml = function()
{
 var featureItem = $(this);
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
     WebDeveloper.Overlay.openTab(getCurrentHostWithProtocol(tab.url) + "/sitemap.xml", featureItem);
 });
};


WebDeveloper.Overlay.Tools.joomlagoogle = function()
{
        var featureItem = $(this);
...
WebDeveloper.Overlay.Tools.joomlapingdom = function()
{
        var featureItem = $(this);
...
WebDeveloper.Overlay.Tools.joomlabase64image = function()
{
        ...
        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab("http://www.base64-image.de/step-1.php", featureItem);
        });
};
...
WebDeveloper.Overlay.Tools.joomlamd5 = function()
{
        ...
        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab("http://www.md5.cz/", featureItem);
        });
};

WebDeveloper.Overlay.Tools.joomlabase64en = function()
{
        var featureItem = $(this);

        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab("http://www.base64encode.org/", featureItem);
        });
};

WebDeveloper.Overlay.Tools.joomlaasci = function()
{
        var featureItem = $(this);

        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab("http://www.network-science.de/ascii/", featureItem);
        });
};

WebDeveloper.Overlay.Tools.joomlaregexpal = function()
{
        var featureItem = $(this);
...
WebDeveloper.Overlay.Tools.joomlafunctions = function()
{
        var featureItem = $(this);

        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab("http://ru.functions-online.com/preg_match.html", featureItem);
        });
};


WebDeveloper.Overlay.Tools.joomlaquirktools = function()
{
        var featureItem = $(this);
...
WebDeveloper.Overlay.Tools.joomlamobiletest = function()
{
        var featureItem = $(this);
...
WebDeveloper.Overlay.Tools.joomlaresponsivedesign = function()
{
        var featureItem = $(this);
...
WebDeveloper.Overlay.Tools.joomlarobots = function()
{
 var featureItem = $(this);
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
     WebDeveloper.Overlay.openTab(getCurrentHostWithProtocol(tab.url) + "/robots.txt", featureItem);
 });
};

WebDeveloper.Overlay.Tools.sitemapwriter = function()
{
        var featureItem = $(this);

        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab("http://www.sitemapwriter.com/notify.php?lang=ru&crawler=all&url=" + getCurrentHostWithProtocol(tab.url) + '/sitemap.xml', featureItem);
        });
};

function getCurrentHostWithProtocol(url) {
     var indexOfDoubleSlash = url.indexOf('//');
     var protocol = url.substr(0, indexOfDoubleSlash == -1 ? 0 : indexOfDoubleSlash + 2);
     var currentUrlWithoutProtocol = url.substr(indexOfDoubleSlash == -1 ? 0 : indexOfDoubleSlash + 2)
     var host = currentUrlWithoutProtocol.split('/')[0];

     return protocol + host;
};

function getCurrentHostWithHost(url) {
     var indexOfDoubleSlash = url.indexOf('//');
     var protocol = url.substr(0, indexOfDoubleSlash == -1 ? 0 : indexOfDoubleSlash + 2);
     var currentUrlWithoutProtocol = url.substr(indexOfDoubleSlash == -1 ? 0 : indexOfDoubleSlash + 2)
     var host = currentUrlWithoutProtocol.split('/')[0];
 ...
 WebDeveloper.Overlay.Tools.joomlaahrefs = function()
{
        var featureItem = $(this);

        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab("https://ahrefs.com/site-explorer/overview/subdomains/" + getCurrentHostWithHost(tab.url), featureItem);
        });
};

 WebDeveloper.Overlay.Tools.joomlaspywords = function()
{
        var featureItem = $(this);

        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab("http://spywords.ru/sword.php?sword=" + getCurrentHostWithHost(tab.url), featureItem);
        });
};
 ...
 WebDeveloper.Overlay.Tools.joomlasemrush = function()
{
        ...
        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab("http://www.semrush.com/ru/info/" + getCurrentHostWithHost(tab.url), featureItem);
        });
};


 WebDeveloper.Overlay.Tools.joomlasimilarweb = function()
{
        var featureItem = $(this);
...
WebDeveloper.Overlay.Tools.joomlaardd = function()
{
 ...
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
     WebDeveloper.Overlay.openTab(getCurrentHostWithProtocol(tab.url) + "/administrator/index.php?option=com_content&task=add", featureItem);
 });
};

WebDeveloper.Overlay.Tools.sectadd = function()
{
 var featureItem = $(this);
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
     WebDeveloper.Overlay.openTab(getCurrentHostWithProtocol(tab.url) + "/administrator/index.php?option=com_sections&scope=content", featureItem);
 });
};

WebDeveloper.Overlay.Tools.catadd = function()
{
 var featureItem = $(this);
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
     WebDeveloper.Overlay.openTab(getCurrentHostWithProtocol(tab.url) + "/administrator/index.php?option=com_categories&section=com_content", featureItem);
 });
};

WebDeveloper.Overlay.Tools.allcontent = function()
{
 var featureItem = $(this);
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
     WebDeveloper.Overlay.openTab(getCurrentHostWithProtocol(tab.url) + "/administrator/index.php?option=com_content", featureItem);
 })
};

WebDeveloper.Overlay.Tools.mod = function()
{
 var featureItem = $(this);
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
     WebDeveloper.Overlay.openTab(getCurrentHostWithProtocol(tab.url) + "/administrator/index.php?option=com_modules", featureItem);
 });
};

WebDeveloper.Overlay.Tools.plg = function()
{
 var featureItem = $(this);
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
     WebDeveloper.Overlay.openTab(getCurrentHostWithProtocol(tab.url) + "/administrator/index.php?option=com_plugins", featureItem);
 });
};

WebDeveloper.Overlay.Tools.template = function()
{
 var featureItem = $(this);
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
     WebDeveloper.Overlay.openTab(getCurrentHostWithProtocol(tab.url) + "/administrator/index.php?option=com_templates", featureItem);
 });
};



WebDeveloper.Overlay.Tools.adddel = function()
{
 var featureItem = $(this);
 WebDeveloper.Overlay.getSelectedTab(function(tab)
 {
     WebDeveloper.Overlay.openTab(getCurrentHostWithProtocol(tab.url) + "/administrator/index.php?option=com_installer", featureItem);
 });
};
...
WebDeveloper.Overlay.Tools.joomlagtmetrix = function()
{
        var featureItem = $(this);
...
WebDeveloper.Overlay.Tools.joomlaperfmapzeman = function()
{
        var featureItem = $(this);

        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab("https://gist.github.com/CB9TOIIIA/cd83abc81e43a3ba32fd", featureItem);
        });
};
...
WebDeveloper.Overlay.Tools.joomlaoptimincode = function()
{
        ...
        WebDeveloper.Overlay.getSelectedTab(function(tab)
        {
                WebDeveloper.Overlay.openTab("http://cssminifier.com/", featureItem);
        });
};
